...
if __name__ == "__main__":
    ...
    for dataset, dataset_idx in datasets:
        ...
        models_path = (
            settings["models_wafamole_path"] if ds_wafamole else settings["models_path"]
        )
        dataset_path = (
            settings["dataset_wafamole_path"]
            if ds_wafamole
        ...
        loader = DataLoader(
            legitimate_path=legitimate_test_path, malicious_path=malicious_path
        )
        ...
        adv_inf_svm_loader = DataLoader(
            malicious_path=adv_infsvm_pl_path % pl, legitimate_path=legitimate_test_path
        )
        ...
        adv_rf_loader = DataLoader(
            malicious_path=adv_rf_path % pl, legitimate_path=legitimate_test_path
        )
        ...
        if ds_wafamole:
            ...
            adv_train_test_log_reg_l1_data = (
                train_test_adv_log_reg_l1_loader.load_data_pkl()
            )
            adv_train_test_log_reg_l2_data = (
                train_test_adv_log_reg_l2_loader.load_data_pkl()
            )
            adv_train_test_svm_linear_l1_data = (
                train_test_adv_svm_linear_l1_loader.load_data_pkl()
            )
            adv_train_test_svm_linear_l2_data = (
                train_test_adv_svm_linear_l2_loader.load_data_pkl()
            )
            ...
            adv_train_test_log_reg_l1_data = (
                train_test_adv_log_reg_l1_loader.load_data()
            )
            adv_train_test_log_reg_l2_data = (
                train_test_adv_log_reg_l2_loader.load_data()
            )
            adv_train_test_svm_linear_l1_data = (
                train_test_adv_svm_linear_l1_loader.load_data()
            )
            adv_train_test_svm_linear_l2_data = (
                train_test_adv_svm_linear_l2_loader.load_data()
            )
        ...
        adv_inf_svm_xts, adv_inf_svm_yts = extractor.extract_features(
            adv_test_inf_svm_data
        )
        adv_log_reg_l1_xts, adv_log_reg_l1_yts = extractor.extract_features(
            adv_test_log_reg_l1_data
        )
        adv_log_reg_l2_xts, adv_log_reg_l2_yts = extractor.extract_features(
            adv_test_log_reg_l2_data
        )
        adv_svm_linear_l1_xts, adv_svm_linear_l1_yts = extractor.extract_features(
            adv_test_svm_linear_l1_data
        )
        adv_svm_linear_l2_xts, adv_svm_linear_l2_yts = extractor.extract_features(
            adv_test_svm_linear_l2_data
        )
        adv_rf_xts, adv_rf_yts = extractor.extract_features(adv_test_rf_data)
        train_test_adv_inf_svm_xts, train_test_adv_inf_svm_yts = (
            extractor.extract_features(adv_train_test_inf_svm_data)
        )
        train_test_adv_log_reg_l1_xts, train_test_adv_log_reg_l1_yts = (
            extractor.extract_features(adv_train_test_log_reg_l1_data)
        )
        train_test_adv_log_reg_l2_xts, train_test_adv_log_reg_l2_yts = (
            extractor.extract_features(adv_train_test_log_reg_l2_data)
        )
        train_test_adv_svm_linear_l1_xts, train_test_adv_svm_linear_l1_yts = (
            extractor.extract_features(adv_train_test_svm_linear_l1_data)
        )
        train_test_adv_svm_linear_l2_xts, train_test_adv_svm_linear_l2_yts = (
            extractor.extract_features(adv_train_test_svm_linear_l2_data)
        )
        train_test_adv_rf_xts, train_test_adv_rf_yts = extractor.extract_features(
            adv_train_test_rf_data
        )
    ...
    fig.supxlabel("False Positive Rate (FPR)", fontsize=16)
    fig.supylabel("True Positive Rate (TPR)", fontsize=16)
