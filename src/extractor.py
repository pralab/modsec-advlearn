...
class ModSecurityFeaturesExtractor:
    """
    Class to extract features using ModSecurity WAF.
    """
    ...
    def __init__(
        ...
        self._pymodsec = PyModSecurity(crs_path, crs_threshold, crs_pl)
    ...
    def extract_features_wafamole(self, value):
        """
        Returns the features vector for the provided value.
